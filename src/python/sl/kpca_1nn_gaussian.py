...
from kernels import gaussian_c
...
results_train = {}
Nsplits = 20
Ncomponents = list(range(40, 81))
Nc = [0.010, 0.015, 0.02, 0.025]

Nparams = Nc

store = pd.HDFStore('kpca_1nn_gaussian_40_81_2.hdf5', 'a')
